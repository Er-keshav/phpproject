...
<body>
    ...
    <div class="container mb-5">
        <h1 class="text-center mt-5 font-weight-light font-bold">My Listed Cars</h1>
            ...
            <div class="container mt-4 ml-3 ">
                 <button type="button" class="btn btn-primary px-auto " data-toggle="modal" data-target="#AddListing"> ADD NEW CARS TO LIST </button>
    ...
    $(document).ready(function() {
        ...
        $('.viewbtn').on('click', function() {
            ...
            $('#editid').val();
            $('#editmodelname').val(data[1]);
            $('#editmodelnumber').val(data[2]);
            $('#editseats').val(data[3]);
